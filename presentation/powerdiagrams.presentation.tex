...
\begin{frame}
    ...
    \centering
    \begin{tikzpicture}
        \path[use as bounding box] (-4, -3.05) rectangle (7, 4.05);
        \path[clip] (-5, -3.05) rectangle (7.5, 4.05);

        \node[sphere center] (s1) at (     2.0,     3.0) {};
        \node[sphere center] (s2) at (     5.0,     0.0) {};
        \node[sphere center] (s3) at (    -2.0,     0.0) {};
        \node[sphere center] (s4) at (     2.0,     0.0) {};
        \node[sphere center] (s5) at (     4.0,     2.0) {};
        ...
        \only<2-3> {
            ...
            \draw[internal edge] (p1v) edge (p3v);
            \draw[extremal edge] (p2v) edge ($(p2v) + 10*(     0.0,    -1.0)$);
        }

        \only<3> {
            \draw[internal edge] (p2v) edge (p3v);
            \draw[extremal edge] (p1v) edge ($(p1v) + 10*(    -0.0,    -1.0)$);
            \draw[extremal edge] (p1v) edge ($(p1v) + 10*(    -0.6,     0.8)$);
            \draw[extremal edge] (p2v) edge ($(p2v) + 10*(  0.8944,  0.4472)$);
            \draw[extremal edge] (p3v) edge ($(p3v) + 10*(  0.4472,  0.8944)$);
        ...
        \only<5> {
            ...
            \draw[extremal edge] (p1) edge ($(p1) + 10*(    -0.6,     0.8)$);
            \draw[extremal edge] (p1) edge ($(p1) + 10*(     0.0,    -1.0)$);
            \draw[internal edge] (p1) edge (p3);
            \draw[extremal edge] (p2) edge ($(p2) + 10*(    -0.0,    -1.0)$);
            \draw[extremal edge] (p2) edge ($(p2) + 10*(  0.8944,  0.4472)$);
            \draw[internal edge] (p2) edge (p3);
            \draw[extremal edge] (p3) edge ($(p3) + 10*(  0.4472,  0.8944)$);
    ...
    \begin{tikzpicture}[y=0.80pt, x=0.80pt, yscale=-0.8, xscale=1, inner sep=0pt, outer sep=0pt,font=\scriptsize]
        \begin{scope}[cm={{1.25,0.0,0.0,-1.25,(0.0,900.0)}}]
            ...
            \only<4> {
                \node at (140, 335) {$
                    \begin{aligned}
                        \MoveEqLeft x \in \Pi\left( (z, r^2) \right) \Leftrightarrow\\
                        &x_{d+1} = 2 x_{[d]}^T z - z^Tz + r^2
                    \end{aligned}$};
            }
...
\begin{frame}
    ...
    \begin{theorem}
        Sei $P$ ein $(d+1)$-Polyeder, der nur von Halbräumen beschränkt wird, deren \structure{Normalenvektoren nach unten zeigen}.
        Dann existiert ein \structure{zu $P$ äquivalentes Powerdiagramm} in $d$ Dimensionen und umgekehrt.
    \end{theorem}
\end{frame}

\begin{frame}<-7>[label=polarisation]
    ...
    \begin{tikzpicture}[y=0.80pt, x=0.80pt, yscale=-1.000000, xscale=1.000000, inner sep=0pt, outer sep=0pt]
        \begin{scope}[cm={{1.25,0.0,0.0,-1.25,(0.0,900.0)}}]
            ...
            % Primal polyhedron
            \only<2-> {
                \begin{scope}[draw=tumorange, very thick,onslide={<5> black, thick}]
                ...
                \end{scope}
                \path[draw=tumorange, very thick, onslide={<5> tumgreen},opacity=0.990,line join=miter,line cap=butt,even odd rule] (261.1692,437.3901) -- (234.9553,385.6223);
            ...
            % Dual polytope
            \only<7-> {
                \begin{scope}[draw=black,thick,onslide={<8-> tumorange, very thick}]
                ...
                \end{scope}
                \path[draw=black,thick, onslide={<9-> tumgreen, very thick, dashed}, line join=miter,line cap=butt,miter limit=4.00,even odd
                rule] (d2) -- (d4);
            }

            \only<5-> {
                \begin{scope}[draw=black,thick,onslide={<5> tumgreen, very thick}, onslide={<8-> tumorange, very thick}]
                    \path[draw,line join=miter,line cap=butt,miter limit=4.00,even odd
                    rule] (209.2463,285.8057) -- (268.9208,245.8557);
                \end{scope}
            }
            ...
            \only<3-4> {
                \node at (125, 255) {$
                    \begin{aligned}
                        \Delta(\Pi(s)) = \left\{ \begin{pmatrix} z \\ z^Tz - r^2 \end{pmatrix} \right\}
                    \end{aligned}$};
            }
            ...
            \only<5> {
                \node at (125, 255) {$
                    \begin{aligned}
                        \Delta(f) = \bigcup_{\mathclap{\substack{h \text{ Hyperebene},\\f \subseteq h}}} \Delta(h)
                    \end{aligned}$};
            }
            ...
            \only<3-5> {
                \draw[arrows={-latex}, thick] (p2) -- ($(p2) + (-15, -12)$);
            }
            \only<4-5> {
                \draw[arrows={-latex}, thick] (p3) -- ($(p3) + (15, -12)$);
            }
        \end{scope}
    \end{tikzpicture}
\end{frame}
