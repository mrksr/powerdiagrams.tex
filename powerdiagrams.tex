...
The transformation function $\Pi$ will then map any $d$-dimensional sphere $s = (z, r^2)$ with the center $z \in h_0$ to the hyperplane
\begin{align}
    ...
    \intertext{and vice versa. Note that}
...
\section{Finding Power Diagrams}
