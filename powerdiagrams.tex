...
\begin{figure}[tb]
    ...
    \begin{tikzpicture}
        ...
        \node[point] () at (p3) {};
    \end{tikzpicture}
    \caption{The power diagram of the five sites $\PD(\left\{ s_1, \dots, s_5 \right\})$ is the set of their cells, whose boundaries are shown in the figure. Boundaries are defined by sets of points for which adjacent sites have equal power.}
    \label{fig:garage}
\end{figure}
...
\subsection{The Transform to $d+1$ Dimensions}
