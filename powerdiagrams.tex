...
\begin{proof}
    ...
    Then let \Wlog \todo{Was ist mit den senkrechten Ebenen?}$N = \left\{ n \in X^\bot \mid n_{d+1} = 1 \right\}$ the set of all possible normal vectors and
    \begin{align}
        \Delta(F) &= \Delta(h(N))\\
